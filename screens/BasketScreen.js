...
export default function BasketScreen() {
  ...
  return (
    <SafeAreaView style={{ paddingTop: inset.top }} className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        ...
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupItemsInBucket).map(([key, items]) => (
            <View
              ...
              <Text className="text-gray-600">{items[0]?.price} USD</Text>
              <TouchableOpacity>
                <Text
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          <View className="flex-row justify-between">
            ...
            <Text className="text-gray-400">{basketTotal} USD</Text>
          </View>
          <View className="flex-row justify-between">
            <Text className="text-gray-400">Delivery Fee</Text>
            <Text className="text-gray-400">{2.99} USD</Text>
          </View>
          <View className="flex-row justify-between">
            <Text>Order Total</Text>
            <Text className="font-extrabold">{basketTotal + 2.99} USD</Text>
          </View>
          <TouchableOpacity
